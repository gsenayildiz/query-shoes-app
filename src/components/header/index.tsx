...
const Header = () => {
  return (
    <header className="flex justify-between items-center bg-white-fa p-4  md:p-5 lg:p-6 xl:p-8 rounded-[12px] md:rounded-[16px] lg:rounded-[20px] xl:rounded-[24px] text-gray-dark mb-6 md:mb-10 lg:mb-15 xl:mb-20">
